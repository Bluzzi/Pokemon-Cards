...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-244ed33f.js",
      css: ["/./_app/assets/start-b97461fb.css"],
      js: ["/./_app/start-244ed33f.js", "/./_app/chunks/vendor-956ff56e.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "img/icon.png", "size": 4102, "type": "image/png" }, { "file": "img/loading.svg", "size": 657, "type": "image/svg+xml" }, { "file": "img/next.svg", "size": 869, "type": "image/svg+xml" }, { "file": "style/base.css", "size": 366, "type": "text/css" }, { "file": "style/normalize.css", "size": 6539, "type": "text/css" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/set\/([^/]+?)\/?$/,
      params: (m2) => ({ id: d(m2[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/set/[id].svelte"],
      b: ["src/routes/__error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/set/[id].svelte": () => Promise.resolve().then(function() {
    return _id_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-90bab741.js", "css": ["/./_app/assets/pages/__layout.svelte-8f14e73d.css"], "js": ["/./_app/pages/__layout.svelte-90bab741.js", "/./_app/chunks/vendor-956ff56e.js", "/./_app/chunks/Store-36852678.js"], "styles": null }, "src/routes/__error.svelte": { "entry": "/./_app/pages/__error.svelte-8715666c.js", "css": ["/./_app/assets/pages/__error.svelte-a527366e.css"], "js": ["/./_app/pages/__error.svelte-8715666c.js", "/./_app/chunks/vendor-956ff56e.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-4fe6df22.js", "css": ["/./_app/assets/pages/index.svelte-42e74d60.css"], "js": ["/./_app/pages/index.svelte-4fe6df22.js", "/./_app/chunks/vendor-956ff56e.js"], "styles": null }, "src/routes/set/[id].svelte": { "entry": "/./_app/pages/set/[id].svelte-9c1589fd.js", "css": ["/./_app/assets/pages/set/[id].svelte-cea46e80.css"], "js": ["/./_app/pages/set/[id].svelte-9c1589fd.js", "/./_app/chunks/vendor-956ff56e.js", "/./_app/chunks/Store-36852678.js"], "styles": null } };
...
async function jsonFetch(link, request = {}) {
...
var Endpoints = {
  ...
  superTypes: api + "supertypes",
  rarities: api + "rarities"
};
var css$6 = {
  code: "nav.svelte-enh8p6.svelte-enh8p6{display:flex;align-items:center;justify-content:space-between;padding:0 5%;height:60px;background-color:#3c5aa6}nav.svelte-enh8p6 img.svelte-enh8p6{height:80%;width:auto}nav.svelte-enh8p6 a.svelte-enh8p6{font-size:1.3em;text-decoration:none;color:#fff;margin-left:15px}nav.svelte-enh8p6 a.svelte-enh8p6:hover,nav.svelte-enh8p6 a.active.svelte-enh8p6{border-bottom:solid 4px #fff}",
  map: '{"version":3,"file":"Navbar.svelte","sources":["Navbar.svelte"],"sourcesContent":["<script>import { onMount } from \\"svelte\\";\\r\\n// Pages :\\r\\nconst navItems = [\\r\\n    { name: \\"Home\\", route: \\"/\\" }\\r\\n];\\r\\n// Get the current active page (for the first call) :\\r\\nlet currentPage = \\"\\";\\r\\nonMount(() => currentPage = location.pathname);\\r\\n// Function for update active page :\\r\\nfunction changeActive(element) {\\r\\n    document.getElementsByClassName(\\"active\\")[0].classList.remove(\\"active\\");\\r\\n    element.classList.add(\\"active\\");\\r\\n}\\r\\n<\/script>\\n\\n<nav>\\n    <img src=\\"/img/icon.png\\" alt=\\"logo\\">\\n\\n    <div class=\\"links\\">\\n        {#each navItems as item}\\n            <a href={item.route} class={currentPage === item.route ? \\"active\\" : \\"\\"} on:click={event => changeActive(event.target)}>{item.name}</a>    \\n        {/each}\\n    </div>\\n</nav>\\n\\n<style>nav{display:flex;align-items:center;justify-content:space-between;padding:0 5%;height:60px;background-color:#3c5aa6}nav img{height:80%;width:auto}nav a{font-size:1.3em;text-decoration:none;color:#fff;margin-left:15px}nav a:hover,nav a.active{border-bottom:solid 4px #fff}</style>"],"names":[],"mappings":"AAyBO,+BAAG,CAAC,QAAQ,IAAI,CAAC,YAAY,MAAM,CAAC,gBAAgB,aAAa,CAAC,QAAQ,CAAC,CAAC,EAAE,CAAC,OAAO,IAAI,CAAC,iBAAiB,OAAO,CAAC,iBAAG,CAAC,iBAAG,CAAC,OAAO,GAAG,CAAC,MAAM,IAAI,CAAC,iBAAG,CAAC,eAAC,CAAC,UAAU,KAAK,CAAC,gBAAgB,IAAI,CAAC,MAAM,IAAI,CAAC,YAAY,IAAI,CAAC,iBAAG,CAAC,eAAC,MAAM,CAAC,iBAAG,CAAC,CAAC,qBAAO,CAAC,cAAc,KAAK,CAAC,GAAG,CAAC,IAAI,CAAC"}'
};
var Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"svelte-enh8p6"}"><img src="${"/img/icon.png"}" alt="${"logo"}" class="${"svelte-enh8p6"}">

    <div class="${"links"}">${each(navItems, (item) => `<a${add_attribute("href", item.route, 0)} class="${escape2(null_to_empty(currentPage === item.route ? "active" : "")) + " svelte-enh8p6"}">${escape2(item.name)}</a>`)}</div>
</nav>`;
});
var currentSet = writable2();
var cards = writable2([]);
var css$5 = {
  code: ".serie.svelte-15z0k0j.svelte-15z0k0j{margin:30px 20px}.serie.svelte-15z0k0j h3.svelte-15z0k0j,.serie.svelte-15z0k0j p.svelte-15z0k0j{cursor:pointer}.serie.svelte-15z0k0j h3.svelte-15z0k0j{text-transform:uppercase;font-size:1em;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.serie.svelte-15z0k0j h3 img.svelte-15z0k0j{height:12px;transition:transform .2s}.serie.svelte-15z0k0j h3 img.is-open.svelte-15z0k0j{transform:rotate(90deg)}.serie.svelte-15z0k0j p.svelte-15z0k0j{font-size:.9em;margin-left:10px}.serie.svelte-15z0k0j p a.svelte-15z0k0j{text-decoration:none;color:#59626f}.serie.svelte-15z0k0j p a.svelte-15z0k0j:hover,.serie.svelte-15z0k0j p a.active.svelte-15z0k0j{border-bottom:4px solid #ffcb05}",
  map: '{"version":3,"file":"SerieSets.svelte","sources":["SerieSets.svelte"],"sourcesContent":["<script>;\\r\\nimport { fly } from \\"svelte/transition\\";\\r\\nimport { currentSet, cards } from \\"$lib/stores/Store\\";\\r\\nexport let serie;\\r\\nexport let sets;\\r\\nexport let isOpen = false;\\r\\nfunction updateSet(set) {\\r\\n    currentSet.set(set);\\r\\n    cards.set([]);\\r\\n}\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"serie\\">\\r\\n    <h3 on:click={() => isOpen = !isOpen}>\\r\\n        <img src=\\"/img/next.svg\\" alt=\\"open {serie} serie\\" class={isOpen ? \\"is-open\\" : \\"\\"}>\\r\\n        {serie}\\r\\n    </h3>\\r\\n\\r\\n    {#if isOpen}\\r\\n        {#each sets as set}\\r\\n            <p transition:fly={{y: -15, duration: 500}}>\\r\\n                <a class={$currentSet === set ? \\"active\\" : \\"\\"} on:click={() => updateSet(set)} href=\\"/set/{set.id}\\">{set.name}</a>\\r\\n            </p>\\r\\n        {/each}\\r\\n    {/if}\\r\\n</div>\\r\\n\\r\\n<style>.serie{margin:30px 20px}.serie h3,.serie p{cursor:pointer}.serie h3{text-transform:uppercase;font-size:1em;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.serie h3 img{height:12px;transition:transform .2s}.serie h3 img.is-open{transform:rotate(90deg)}.serie p{font-size:.9em;margin-left:10px}.serie p a{text-decoration:none;color:#59626f}.serie p a:hover,.serie p a.active{border-bottom:4px solid #ffcb05}</style>"],"names":[],"mappings":"AA2BO,oCAAM,CAAC,OAAO,IAAI,CAAC,IAAI,CAAC,qBAAM,CAAC,iBAAE,CAAC,qBAAM,CAAC,gBAAC,CAAC,OAAO,OAAO,CAAC,qBAAM,CAAC,iBAAE,CAAC,eAAe,SAAS,CAAC,UAAU,GAAG,CAAC,oBAAoB,IAAI,CAAC,iBAAiB,IAAI,CAAC,gBAAgB,IAAI,CAAC,YAAY,IAAI,CAAC,qBAAM,CAAC,EAAE,CAAC,kBAAG,CAAC,OAAO,IAAI,CAAC,WAAW,SAAS,CAAC,GAAG,CAAC,qBAAM,CAAC,EAAE,CAAC,GAAG,uBAAQ,CAAC,UAAU,OAAO,KAAK,CAAC,CAAC,qBAAM,CAAC,gBAAC,CAAC,UAAU,IAAI,CAAC,YAAY,IAAI,CAAC,qBAAM,CAAC,CAAC,CAAC,gBAAC,CAAC,gBAAgB,IAAI,CAAC,MAAM,OAAO,CAAC,qBAAM,CAAC,CAAC,CAAC,gBAAC,MAAM,CAAC,qBAAM,CAAC,CAAC,CAAC,CAAC,sBAAO,CAAC,cAAc,GAAG,CAAC,KAAK,CAAC,OAAO,CAAC"}'
};
var SerieSets = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $currentSet, $$unsubscribe_currentSet;
  $$unsubscribe_currentSet = subscribe(currentSet, (value) => $currentSet = value);
  let { serie } = $$props;
  let { sets } = $$props;
  let { isOpen = false } = $$props;
  if ($$props.serie === void 0 && $$bindings.serie && serie !== void 0)
    $$bindings.serie(serie);
  if ($$props.sets === void 0 && $$bindings.sets && sets !== void 0)
    $$bindings.sets(sets);
  if ($$props.isOpen === void 0 && $$bindings.isOpen && isOpen !== void 0)
    $$bindings.isOpen(isOpen);
  $$result.css.add(css$5);
  $$unsubscribe_currentSet();
  return `<div class="${"serie svelte-15z0k0j"}"><h3 class="${"svelte-15z0k0j"}"><img src="${"/img/next.svg"}" alt="${"open " + escape2(serie) + " serie"}" class="${escape2(null_to_empty(isOpen ? "is-open" : "")) + " svelte-15z0k0j"}">
        ${escape2(serie)}</h3>

    ${isOpen ? `${each(sets, (set) => `<p class="${"svelte-15z0k0j"}"><a class="${escape2(null_to_empty($currentSet === set ? "active" : "")) + " svelte-15z0k0j"}" href="${"/set/" + escape2(set.id)}">${escape2(set.name)}</a>
            </p>`)}` : ``}
</div>`;
});
var css$4 = {
  code: ".content.svelte-1a3o9j7.svelte-1a3o9j7{height:calc(100vh - 60px - 40px);width:100%;display:flex}.content.svelte-1a3o9j7 .nav-sets.svelte-1a3o9j7{width:-webkit-max-content;width:-moz-max-content;width:max-content;background-color:#fff;overflow-y:scroll;margin:0}.content.svelte-1a3o9j7 .cards.svelte-1a3o9j7{overflow-y:scroll;width:inherit;display:flex;justify-content:center;position:relative}@media(max-width: 768px){.content.svelte-1a3o9j7 .cards.svelte-1a3o9j7{padding:30px 1rem}}footer.svelte-1a3o9j7.svelte-1a3o9j7{display:flex;align-items:center;justify-content:center;background-color:#3c5aa6;height:40px}footer.svelte-1a3o9j7 p.svelte-1a3o9j7,footer.svelte-1a3o9j7 a.svelte-1a3o9j7{color:#fff}footer.svelte-1a3o9j7 a.svelte-1a3o9j7{text-decoration:underline}",
  map: '{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script context=\\"module\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\r\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\r\\n    return new (P || (P = Promise))(function (resolve, reject) {\\r\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\r\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\r\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\r\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\r\\n    });\\r\\n};\\r\\nimport Endpoints from \\"$lib/pokemontcg/Endpoints\\";\\r\\nimport { jsonFetch } from \\"$lib/utils/Fetch\\";\\r\\nexport function load() {\\r\\n    return __awaiter(this, void 0, void 0, function* () {\\r\\n        try {\\r\\n            const json = yield jsonFetch(Endpoints.sets);\\r\\n            return {\\r\\n                props: {\\r\\n                    sets: json.data\\r\\n                }\\r\\n            };\\r\\n        }\\r\\n        catch (err) {\\r\\n            return {\\r\\n                status: 400,\\r\\n                error: new Error(err)\\r\\n            };\\r\\n        }\\r\\n    });\\r\\n}\\r\\n<\/script>\\n\\n<script>import Navbar from \\"$lib/components/Navbar.svelte\\";\\r\\nimport SerieSet from \\"$lib/components/elements/SerieSets.svelte\\";\\r\\n;\\r\\nexport let sets;\\r\\nconst setsBySeries = {};\\r\\nsets.forEach(set => {\\r\\n    if (setsBySeries[set.series]) {\\r\\n        setsBySeries[set.series].push(set);\\r\\n    }\\r\\n    else {\\r\\n        setsBySeries[set.series] = [set];\\r\\n    }\\r\\n});\\r\\nconst series = Object.keys(setsBySeries).reverse();\\r\\n<\/script>\\n\\n<Navbar/>\\n\\n<div class=\\"content\\">\\n    <div class=\\"nav-sets\\">\\n        {#each series as serie, i}\\n            <SerieSet serie={serie} sets={setsBySeries[serie]} isOpen={i === 0}/>\\n        {/each}\\n    </div>\\n    <div class=\\"cards\\">\\n        <slot></slot>\\n    </div>\\n</div>\\n\\n<footer>\\n    <p>Pok\xE9mon Cards - Created by the <a href=\\"https://royaume.world\\">Royaume</a></p>\\n</footer>\\n\\n<style>.content{height:calc(100vh - 60px - 40px);width:100%;display:flex}.content .nav-sets{width:-webkit-max-content;width:-moz-max-content;width:max-content;background-color:#fff;overflow-y:scroll;margin:0}.content .cards{overflow-y:scroll;width:inherit;display:flex;justify-content:center;position:relative}@media(max-width: 768px){.content .cards{padding:30px 1rem}}footer{display:flex;align-items:center;justify-content:center;background-color:#3c5aa6;height:40px}footer p,footer a{color:#fff}footer a{text-decoration:underline}</style>"],"names":[],"mappings":"AAgEO,sCAAQ,CAAC,OAAO,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,MAAM,IAAI,CAAC,QAAQ,IAAI,CAAC,uBAAQ,CAAC,wBAAS,CAAC,MAAM,mBAAmB,CAAC,MAAM,gBAAgB,CAAC,MAAM,WAAW,CAAC,iBAAiB,IAAI,CAAC,WAAW,MAAM,CAAC,OAAO,CAAC,CAAC,uBAAQ,CAAC,qBAAM,CAAC,WAAW,MAAM,CAAC,MAAM,OAAO,CAAC,QAAQ,IAAI,CAAC,gBAAgB,MAAM,CAAC,SAAS,QAAQ,CAAC,MAAM,YAAY,KAAK,CAAC,CAAC,uBAAQ,CAAC,qBAAM,CAAC,QAAQ,IAAI,CAAC,IAAI,CAAC,CAAC,oCAAM,CAAC,QAAQ,IAAI,CAAC,YAAY,MAAM,CAAC,gBAAgB,MAAM,CAAC,iBAAiB,OAAO,CAAC,OAAO,IAAI,CAAC,qBAAM,CAAC,gBAAC,CAAC,qBAAM,CAAC,gBAAC,CAAC,MAAM,IAAI,CAAC,qBAAM,CAAC,gBAAC,CAAC,gBAAgB,SAAS,CAAC"}'
};
...
function load$2() {
  return __awaiter$1(this, void 0, void 0, function* () {
    try {
      const json = yield jsonFetch(Endpoints.sets);
      return { props: { sets: json.data } };
    } catch (err) {
      return { status: 400, error: new Error(err) };
    }
  });
}
...
<div class="${"content svelte-1a3o9j7"}"><div class="${"nav-sets svelte-1a3o9j7"}">${each(series, (serie, i) => `${validate_component(SerieSets, "SerieSet").$$render($$result, {
    serie,
    sets: setsBySeries[serie],
    isOpen: i === 0
  }, {}, {})}`)}</div>
    <div class="${"cards svelte-1a3o9j7"}">${slots.default ? slots.default({}) : ``}</div></div>

<footer class="${"svelte-1a3o9j7"}"><p class="${"svelte-1a3o9j7"}">Pok\xE9mon Cards - Created by the <a href="${"https://royaume.world"}" class="${"svelte-1a3o9j7"}">Royaume</a></p>
</footer>`;
});
...
var css$3 = {
  code: ".error.svelte-rf8tkn.svelte-rf8tkn{display:flex;align-items:center;justify-content:center;flex-direction:column}.error.svelte-rf8tkn p.svelte-rf8tkn{margin:5px}",
  map: '{"version":3,"file":"__error.svelte","sources":["__error.svelte"],"sourcesContent":["<script context=\\"module\\">;\\r\\nexport function load({ error, status }) {\\r\\n    return {\\r\\n        props: {\\r\\n            errorCode: status,\\r\\n            message: typeof error === \\"string\\" ? error : error.message.toLowerCase()\\r\\n        }\\r\\n    };\\r\\n}\\r\\n<\/script>\\n\\n<script>export let errorCode;\\r\\nexport let message;\\r\\n<\/script>\\n\\n<div class=\\"error\\">\\n\\t<p>Error {errorCode}</p>\\n\\t<p>{message}</p>\\n</div>\\n\\n<style>.error{display:flex;align-items:center;justify-content:center;flex-direction:column}.error p{margin:5px}</style>"],"names":[],"mappings":"AAoBO,kCAAM,CAAC,QAAQ,IAAI,CAAC,YAAY,MAAM,CAAC,gBAAgB,MAAM,CAAC,eAAe,MAAM,CAAC,oBAAM,CAAC,eAAC,CAAC,OAAO,GAAG,CAAC"}'
};
function load$1({ error: error2, status }) {
  return {
    props: {
      errorCode: status,
      message: typeof error2 === "string" ? error2 : error2.message.toLowerCase()
    }
  };
}
var _error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"error svelte-rf8tkn"}"><p class="${"svelte-rf8tkn"}">Error ${escape2(errorCode)}</p>
	<p class="${"svelte-rf8tkn"}">${escape2(message)}</p>
</div>`;
});
...
var css$2 = {
  code: ".first.svelte-6ww8q7.svelte-6ww8q7{display:flex;align-items:center;justify-content:center;flex-direction:column}.first.svelte-6ww8q7 img.svelte-6ww8q7{height:100px}",
  map: '{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<svelte:head>\\n    <title>Pokemon Cards - Sets</title>\\n</svelte:head>\\n\\n<div class=\\"first\\">\\n    <img src=\\"/img/icon.png\\" alt=\\"logo\\">\\n    <p>Bienvenue sur Pokemon Cards !</p>\\n</div>\\n\\n<style>.first{display:flex;align-items:center;justify-content:center;flex-direction:column}.first img{height:100px}</style>"],"names":[],"mappings":"AASO,kCAAM,CAAC,QAAQ,IAAI,CAAC,YAAY,MAAM,CAAC,gBAAgB,MAAM,CAAC,eAAe,MAAM,CAAC,oBAAM,CAAC,iBAAG,CAAC,OAAO,KAAK,CAAC"}'
};
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `${$$result.head += `${$$result.title = `<title>Pokemon Cards - Sets</title>`, ""}`, ""}

<div class="${"first svelte-6ww8q7"}"><img src="${"/img/icon.png"}" alt="${"logo"}" class="${"svelte-6ww8q7"}">
    <p>Bienvenue sur Pokemon Cards !</p>
</div>`;
});
...
var css$1 = {
  code: "img.svelte-14avgyx{margin:30px;width:230px;filter:drop-shadow(0 0 3px rgba(89, 98, 111, 0.4));transition:transform .2s}img.svelte-14avgyx:hover{transform:scale(1.1)}",
  map: '{"version":3,"file":"Card.svelte","sources":["Card.svelte"],"sourcesContent":["<script>;\\r\\nimport { fade } from \\"svelte/transition\\";\\r\\nexport let card;\\r\\nconst link = \\"https://assets.pokemon.com/assets/cms2-fr-fr/img/cards/web/\\" + card.set.id.toUpperCase() +\\r\\n    \\"/\\" + card.set.id.toUpperCase() + \\"_FR_\\" + card.number + \\".png\\";\\r\\n<\/script>\\r\\n\\r\\n<img src={card.images.small} alt=\\"{card.name} card\\" loading=\\"lazy\\" transition:fade>\\r\\n\\r\\n<style>img{margin:30px;width:230px;filter:drop-shadow(0 0 3px rgba(89, 98, 111, 0.4));transition:transform .2s}img:hover{transform:scale(1.1)}</style>"],"names":[],"mappings":"AASO,kBAAG,CAAC,OAAO,IAAI,CAAC,MAAM,KAAK,CAAC,OAAO,YAAY,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,WAAW,SAAS,CAAC,GAAG,CAAC,kBAAG,MAAM,CAAC,UAAU,MAAM,GAAG,CAAC,CAAC"}'
};
var Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { card } = $$props;
  "https://assets.pokemon.com/assets/cms2-fr-fr/img/cards/web/" + card.set.id.toUpperCase() + "/" + card.set.id.toUpperCase() + "_FR_" + card.number + ".png";
  if ($$props.card === void 0 && $$bindings.card && card !== void 0)
    $$bindings.card(card);
  $$result.css.add(css$1);
  return `<img${add_attribute("src", card.images.small, 0)} alt="${escape2(card.name) + " card"}" loading="${"lazy"}" class="${"svelte-14avgyx"}">`;
});
var css = {
  code: ".serie.svelte-1xp7x0e.svelte-1xp7x0e{display:flex;align-items:center;flex-direction:column}.serie.svelte-1xp7x0e .header.svelte-1xp7x0e{margin:40px 0;width:450px}@media(max-width: 768px){.serie.svelte-1xp7x0e .header.svelte-1xp7x0e{width:95%}}.serie.svelte-1xp7x0e .cards.svelte-1xp7x0e{max-width:930px;display:flex;justify-content:center;flex-wrap:wrap;margin-bottom:40px}.serie.svelte-1xp7x0e .load.svelte-1xp7x0e{width:100%;display:flex;align-items:center;justify-content:center}",
  map: `{"version":3,"file":"[id].svelte","sources":["[id].svelte"],"sourcesContent":["<script context=\\"module\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\r\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\r\\n    return new (P || (P = Promise))(function (resolve, reject) {\\r\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\r\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\r\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\r\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\r\\n    });\\r\\n};\\r\\n;\\r\\nexport function load({ page }) {\\r\\n    return __awaiter(this, void 0, void 0, function* () {\\r\\n        return {\\r\\n            props: {\\r\\n                setId: page.params.id,\\r\\n            }\\r\\n        };\\r\\n    });\\r\\n}\\r\\n<\/script>\\r\\n\\r\\n<script>var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\r\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\r\\n    return new (P || (P = Promise))(function (resolve, reject) {\\r\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\r\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\r\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\r\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\r\\n    });\\r\\n};\\r\\nimport Card from \\"$lib/components/elements/Card.svelte\\";\\r\\nimport { jsonFetch } from \\"$lib/utils/Fetch\\";\\r\\nimport Endpoints from \\"$lib/pokemontcg/Endpoints\\";\\r\\nimport { currentSet, cards } from \\"$lib/stores/Store\\";\\r\\nimport { afterUpdate, onMount } from \\"svelte\\";\\r\\n// Get props :\\r\\nexport let setId;\\r\\nlet cardsDiv;\\r\\n// If the visitor has accessed this page without going through the navigation, \\r\\n// an additional request must be made to obtain the set information :\\r\\nif (!$currentSet) {\\r\\n    (() => __awaiter(void 0, void 0, void 0, function* () { return currentSet.set((yield jsonFetch(Endpoints.sets + \\"/\\" + setId)).data); }))();\\r\\n}\\r\\n// Calls on every page load, not just the first one :\\r\\n$: loadCards(), setId;\\r\\n// Create a scroll event on the .cards div,\\r\\n// because Svelte's on:scroll event does not work on an overflow-y div :\\r\\nonMount(() => {\\r\\n    document.querySelector(\\".cards\\").onscroll = scrollLoader;\\r\\n});\\r\\nafterUpdate(() => {\\r\\n    if (!$cards.length) {\\r\\n        console.log(\\"tgm : \\" + setId.toUpperCase());\\r\\n        cardsDiv.style.height = \\"1000px\\";\\r\\n        console.log(cardsDiv);\\r\\n        cardsDiv.scrollTo(0, 0);\\r\\n        setTimeout(() => {\\r\\n            cardsDiv.style.height = \\"auto\\";\\r\\n        }, 1000);\\r\\n    }\\r\\n});\\r\\n// Functions :\\r\\nconst pageSize = 50;\\r\\nlet totalCard;\\r\\nlet nextPage = {\\r\\n    end: false,\\r\\n    next: 1,\\r\\n    isLoaded: true\\r\\n};\\r\\nfunction loadCards(page = 1) {\\r\\n    return __awaiter(this, void 0, void 0, function* () {\\r\\n        jsonFetch(Endpoints.cards + \\"?page=\\" + page + \\"&pageSize=\\" + pageSize + \\"&q=set.id:\\" + setId)\\r\\n            .then(json => {\\r\\n            cards.update(cards => cards.concat(json.data));\\r\\n            totalCard = json.totalCount;\\r\\n            nextPage = {\\r\\n                end: $cards.length >= totalCard,\\r\\n                next: json.page + 1,\\r\\n                isLoaded: false\\r\\n            };\\r\\n        });\\r\\n    });\\r\\n}\\r\\nfunction scrollLoader(event) {\\r\\n    const scrollDiv = event.target;\\r\\n    if (scrollDiv.scrollTop + window.innerHeight >= scrollDiv.scrollHeight) {\\r\\n        if (!nextPage.end && !nextPage.isLoaded) {\\r\\n            loadCards(nextPage.next);\\r\\n            nextPage.isLoaded = true;\\r\\n        }\\r\\n    }\\r\\n}\\r\\n<\/script>\\r\\n\\r\\n<svelte:head>\\r\\n    <title>Pokemon Cards - {$currentSet?.series}</title>\\r\\n</svelte:head>\\r\\n\\r\\n<div class=\\"serie\\">\\r\\n    {#if $currentSet?.images?.logo}\\r\\n        <img src={$currentSet.images.logo} alt=\\"serie logo\\" class=\\"header\\">\\r\\n    {/if}\\r\\n\\r\\n    <div class=\\"cards\\" bind:this={cardsDiv}>\\r\\n        {#each $cards as card}\\r\\n            <Card card={card}/>\\r\\n        {/each}\\r\\n\\r\\n        {#if $cards.length < totalCard}\\r\\n            <div class=\\"load\\">\\r\\n                <img src=\\"/img/loading.svg\\" alt=\\"loading\\">    \\r\\n            </div>\\r\\n        {/if}\\r\\n    </div>\\r\\n</div>\\r\\n\\r\\n<style>.serie{display:flex;align-items:center;flex-direction:column}.serie .header{margin:40px 0;width:450px}@media(max-width: 768px){.serie .header{width:95%}}.serie .cards{max-width:930px;display:flex;justify-content:center;flex-wrap:wrap;margin-bottom:40px}.serie .load{width:100%;display:flex;align-items:center;justify-content:center}</style>"],"names":[],"mappings":"AAoHO,oCAAM,CAAC,QAAQ,IAAI,CAAC,YAAY,MAAM,CAAC,eAAe,MAAM,CAAC,qBAAM,CAAC,sBAAO,CAAC,OAAO,IAAI,CAAC,CAAC,CAAC,MAAM,KAAK,CAAC,MAAM,YAAY,KAAK,CAAC,CAAC,qBAAM,CAAC,sBAAO,CAAC,MAAM,GAAG,CAAC,CAAC,qBAAM,CAAC,qBAAM,CAAC,UAAU,KAAK,CAAC,QAAQ,IAAI,CAAC,gBAAgB,MAAM,CAAC,UAAU,IAAI,CAAC,cAAc,IAAI,CAAC,qBAAM,CAAC,oBAAK,CAAC,MAAM,IAAI,CAAC,QAAQ,IAAI,CAAC,YAAY,MAAM,CAAC,gBAAgB,MAAM,CAAC"}`
};
...
function load({ page }) {
  return __awaiter(this, void 0, void 0, function* () {
    return { props: { setId: page.params.id } };
  });
}
var pageSize = 50;
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if (!$currentSet) {
    (() => __awaiter2(void 0, void 0, void 0, function* () {
      return currentSet.set((yield jsonFetch(Endpoints.sets + "/" + setId)).data);
    }))();
  }
  onMount(() => {
    document.querySelector(".cards").onscroll = scrollLoader;
  ...
  let totalCard;
  let nextPage = { end: false, next: 1, isLoaded: true };
  function loadCards(page = 1) {
    return __awaiter2(this, void 0, void 0, function* () {
      jsonFetch(Endpoints.cards + "?page=" + page + "&pageSize=" + pageSize + "&q=set.id:" + setId).then((json) => {
        cards.update((cards2) => cards2.concat(json.data));
        totalCard = json.totalCount;
        nextPage = {
          end: $cards.length >= totalCard,
          next: json.page + 1,
  ...
  if ($$props.setId === void 0 && $$bindings.setId && setId !== void 0)
    $$bindings.setId(setId);
  $$result.css.add(css);
  {
    loadCards();
  }
  $$unsubscribe_currentSet();
  $$unsubscribe_cards();
  return `${$$result.head += `${$$result.title = `<title>Pokemon Cards - ${escape2($currentSet == null ? void 0 : $currentSet.series)}</title>`, ""}`, ""}

<div class="${"serie svelte-1xp7x0e"}">${((_a = $currentSet == null ? void 0 : $currentSet.images) == null ? void 0 : _a.logo) ? `<img${add_attribute("src", $currentSet.images.logo, 0)} alt="${"serie logo"}" class="${"header svelte-1xp7x0e"}">` : ``}

    <div class="${"cards svelte-1xp7x0e"}"${add_attribute("this", cardsDiv, 1)}>${each($cards, (card) => `${validate_component(Card, "Card").$$render($$result, { card }, {}, {})}`)}

        ${$cards.length < totalCard ? `<div class="${"load svelte-1xp7x0e"}"><img src="${"/img/loading.svg"}" alt="${"loading"}"></div>` : ``}</div>
</div>`;
});
